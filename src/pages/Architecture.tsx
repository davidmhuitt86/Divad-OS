...
export default function Architecture() {
  const { objects, activity, appState, loadObjects, loadAppState, loadActivity } = useStore()
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden', padding: 14, gap: 10 }}>
      ...
      <div style={{ display: 'flex', gap: 10, flex: 1, minHeight: 0 }}>
        <PhasesList phases={phases} activeId={selectedAP?.id ?? null} onSelect={setSelectedAP} />
